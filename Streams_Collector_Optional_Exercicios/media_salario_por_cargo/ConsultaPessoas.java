...
public class ConsultaPessoas {
    ...
    public static TreeMap<String, TreeSet<Pessoa>> obterPessoasAgrupadasPorCargoEmOrdemReversa(List<Pessoa> pessoa1) {
        TreeMap<String, TreeSet<Pessoa>> listaAuxiliar = pessoa1.stream().collect(Collectors.groupingBy(Pessoa::getCargo, () -> new TreeMap<>(Comparator.reverseOrder()), Collectors.toCollection(TreeSet::new)));
